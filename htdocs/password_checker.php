...
printf(
    '<td><input type="%s" name="hash" id="hash" value="%s" /></td>',
    (obfuscate_password_display($request['enc_type']) ? 'password' : 'text'),
    htmlspecialchars($request['hash'])
);
echo '</tr>';
...
printf(
    '<td><input type="password" name="check_password" value="%s" /></td>',
